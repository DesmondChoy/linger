...
const books: LibraryBook[] = [
  ...
  },
  {
    ...
    summaries: [
      'Mr Jones neglects the animals, and Old Major gathers them in the barn to describe a future without human masters. He teaches them “Beasts of England” and urges them to prepare for rebellion before dying a few days later.',
      'The animals unexpectedly drive Mr Jones and his men from Manor Farm when they are not fed. They rename it Animal Farm, destroy the tools of human control, and paint the Seven Commandments of Animalism on the barn wall.',
      'The animals organise the harvest and begin learning to read while the pigs direct the work. By the end of the chapter, Squealer argues that the pigs should receive the milk and apples.',
      'Mr Jones and neighbouring farmers attack Animal Farm. Snowball leads the defence during the Battle of the Cowshed, and the animals drive the humans away.',
      'Snowball and Napoleon argue over the windmill until Napoleon’s dogs chase Snowball from the farm. Napoleon then ends the public meetings and takes control of decisions.',
      'The animals work to build the windmill while Napoleon begins trading with humans and the pigs move into the farmhouse. A storm destroys the windmill, and Napoleon blames Snowball.',
      'Napoleon stages public confessions and has the dogs execute several animals accused of helping Snowball. The remaining animals are shaken, and Clover notices that the commandment against killing has acquired the words “without cause.”',
      'The humans attack Animal Farm and destroy the rebuilt windmill, but the animals drive them away in the Battle of the Windmill. Napoleon calls it a victory even though the animals have lost months of work and many are injured.',
      'The animals struggle through shortages while the pigs enjoy increasing privileges. Boxer works himself beyond his strength; when he collapses, the pigs sell him to a knacker and use the money to buy whisky.',
      'Years later, the farm is prosperous for the pigs but not for the other animals. The Seven Commandments have been reduced to one rule, and the animals watch the pigs dine with humans until they can no longer tell the two apart.',
    ],
  },
]
