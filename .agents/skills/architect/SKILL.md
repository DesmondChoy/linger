...
metadata:
  short-description: settle types and module shape before writing code that crosses a function boundary
---
...
Use up to three architect runners. They inherit the parent model by default, or use valid project-local overrides from [Models](#models).
