...
1. Use the project-available **skill-creator** skill for authoring or updating `SKILL.md` files.
2. Validate the skill: frontmatter has `name` and `description`, referenced files exist, cross-skill links resolve.
3. Test cases if structural; skip if subjective.
4. Run **Opening a PR** only when the user explicitly asks for commit, push, or pull-request work.
