...
1. Locate the prior trail. Use a supplied task or transcript path, a task found with the runtime's task-history tools, a cloud-task URL, or a pushed branch. Read that task with the same tools. Never scan unrelated task histories. Reduce long history to decisions, evidence, and open work.
