...
OUTPUT = Path(__file__).with_name("cross-source-outside-essay-approved.json")
DIAGNOSTICS = Path(__file__).with_name("cross-source-outside-essay-diagnostics.json")
