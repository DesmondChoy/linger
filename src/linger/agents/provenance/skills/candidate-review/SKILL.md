...
description: Review one complete Muse candidate for independent response release and automatic memory capture decisions.
---

Use this skill after Muse produces a draft or its one permitted revision. Review the complete candidate independently, even if Muse declares no factual claims. This task does not run the initial emotional preflight or review Sculptor curation proposals.
