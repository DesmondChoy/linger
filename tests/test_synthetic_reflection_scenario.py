"""Tests for deterministic validation of reflection-and-grounding scenarios."""
...
@pytest.fixture
def scenario(repository_root: Path) -> tuple[dict[str, object], dict[str, object]]:
