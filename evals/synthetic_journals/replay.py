...
from src.linger.agents.librarian.boundary_prompt import (
    EVENT_IDENTIFICATION_PROMPT_FINGERPRINT as LIBRARIAN_EVENT_IDENTIFICATION_PROMPT_FINGERPRINT,
    NO_HISTORY_PROMPT_FINGERPRINT as LIBRARIAN_BOUNDARY_NO_HISTORY_PROMPT_FINGERPRINT,
...
from src.linger.agents.serendipity.prompt import (
    MEMORY_RECALL_PROMPT_FINGERPRINT as SERENDIPITY_RECALL_PROMPT_FINGERPRINT,
    PROMPT_FINGERPRINT as SERENDIPITY_PROMPT_FINGERPRINT,
    SOURCE_GATHERING_PROMPT_FINGERPRINT as SERENDIPITY_GATHERING_PROMPT_FINGERPRINT,
)
...
RUNTIME_PROMPT_FINGERPRINTS = (
    LIBRARIAN_EVENT_IDENTIFICATION_PROMPT_FINGERPRINT,
    LIBRARIAN_BOUNDARY_PROMPT_FINGERPRINT,
    LIBRARIAN_BOUNDARY_NO_HISTORY_PROMPT_FINGERPRINT,
    ...
    SERENDIPITY_RECALL_PROMPT_FINGERPRINT,
    SERENDIPITY_GATHERING_PROMPT_FINGERPRINT,
)
