...
export interface GraphNode {
  ...
  label?: string
  role?: string
  /** Observed facts drawn inside the card, turning the map into its own log. */
  footer?: { left?: string; right?: string; tone?: 'neutral' | 'good' | 'bad' }
  /** A component the turn did not reach: drawn present but unused. */
  muted?: boolean
}
